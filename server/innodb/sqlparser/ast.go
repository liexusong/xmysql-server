...
// is the AST representation of the plan. If a DDL statement
...
// returning a Statement which is the AST representation of the plan.
...
// VindexParam defines a key/valueImpl parameter for a CREATE VINDEX statement
...
type Show struct {
	...
	Scope         string
	ShowValues    *ShowFilter
}

// Format formats the node.
func (node *Show) Format(buf *TrackedBuffer) {
	fmt.Println("======================================")
	if node.Type == "schemas" && node.ShowTablesOpt != nil {
	...
	//if node.ShowValues=="" {
	//	buf.Myprintf("show %s", node.ShowValues)
	//}else{
	//	buf.Myprintf("show %s %s", node.Scope, node.Type)
	//}
	if node.HasOnTable() {
...
// ShowTablesOpt is show schemas option
...
// ShowFilter is show schemas filter
...
func (node *Rollback) Eval() (innodb.Value, error) {
	panic("Rollback")
}
...
func (node *OtherRead) Eval() (innodb.Value, error) {
	panic("OtherRead")
}
...
func (node *OtherAdmin) Eval() (innodb.Value, error) {
	panic("OtherAdmin")
}
...
func (node Comments) Eval() (innodb.Value, error) {
	panic("implement me")
}
...
func (node SelectExprs) Eval() (innodb.Value, error) {
	panic("")
}
...
func (node *StarExpr) Eval() (innodb.Value, error) {
	panic("StarExpr")
}
...
func (node *AliasedExpr) Eval() (innodb.Value, error) {
	panic("AliasedExpr")
}
...
func (node Nextval) Eval() (innodb.Value, error) {
	panic("Nextval")
}
...
func (node Columns) Eval() (innodb.Value, error) {
	panic("Columns")
}
...
func (node Partitions) Eval() (innodb.Value, error) {
	panic("")
}
...
func (node TableExprs) IsArray() bool {
	return len(node) == 1
}
...
func (node TableExprs) Eval() (innodb.Value, error) {

	return node[0].(*AliasedTableExpr).Eval()
}
...
func (node *AliasedTableExpr) Eval() (innodb.Value, error) {

	return node.Expr.(TableName).Eval()
}
...
func (node TableNames) Eval() (innodb.Value, error) {
	panic("TableNames")
}

// TableName represents a table  name.
// Qualifier, if specified, represents a database or keyspace.
// TableName is a valueImpl struct whose fields are case sensitive.
...
func (node TableName) Eval() (innodb.Value, error) {
	return valueImpl.NewVarcharVal([]byte(node.Name.String())), nil
}
...
func (node *ParenTableExpr) Eval() (innodb.Value, error) {
	panic("ParenTableExpr")
}
...
func (node JoinCondition) Eval() (innodb.Value, error) {
	panic("JoinCondition")
}
...
func (node *JoinTableExpr) Eval() (innodb.Value, error) {
	panic("JoinTableExpr")
}
...
func (node *IndexHints) Eval() (innodb.Value, error) {
	panic("IndexHints")
}
...
// Exprs represents a list of valueImpl expressions.
...
func (node *AndExpr) Eval() (innodb.Value, error) {
	panic("")
}
...
func (node *OrExpr) Eval() (innodb.Value, error) {
	panic("OrExpr")
}
...
func (node *NotExpr) Eval() (innodb.Value, error) {
	panic("NotExpr")
}
...
func (node ParenExpr) Eval() (innodb.Value, error) {
...
// ComparisonExpr represents a two-valueImpl comparison expression.
...
func (node *ComparisonExpr) Eval() (innodb.Value, error) {

	leftEval, leftError := node.Left.Eval()

	if leftError != nil {
		return nil, leftError
	}
	rightEval, rightError := node.Right.Eval()
	if rightError != nil {
	...
	case "=":
		{
			result, lastError := leftEval.Equal(rightEval)
			if lastError != nil {
	...
	case ">":
		{
			result, lastError := leftEval.GreaterThan(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
	...
	case ">=":
		{
			result, lastError := leftEval.GreaterOrEqual(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
	...
	case "<":
		{
			result, lastError := leftEval.LessThan(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
	...
	case "=<":
		{
			result, lastError := leftEval.LessOrEqual(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
...
func (node *RangeCond) Eval() (innodb.Value, error) {
	panic("RangeCond")
}
...
func (node *IsExpr) Eval() (innodb.Value, error) {
	panic("IsExpr")
}
...
func (node *ExistsExpr) Eval() (innodb.Value, error) {
...
// SQLVal represents a single valueImpl.
type SQLVal struct {
	Type innodb.ValType
	Val  []byte
}
...
func (s StringValue) Eval() (innodb.Value, error) {
	panic("StringValue")
}
...
func (s StringValue) DataType() innodb.ValType {
	panic("implement me")
}

func (s StringValue) Compare(x innodb.Value) (innodb.CompareType, error) {
	panic("implement me")
}

func (s StringValue) UnaryPlus() (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) UnaryMinus() (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Add(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Sub(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Mul(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Div(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Pow(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Mod(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Equal(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) NotEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) GreaterThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) LessThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) GreaterOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) LessOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) And(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (s StringValue) Or(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}
...
func NewStrVal(in []byte) *SQLVal {
	...
	stringValue.Val = in
	stringValue.Type = innodb.StrVal

	return (*SQLVal)(unsafe.Pointer(stringValue))
}
...
func (i IntegerValue) ToByte() []byte {
	panic("implement me")
}

func NewIntegerValue(val []byte, valType innodb.ValType) *IntegerValue {

	var integerValue = new(IntegerValue)

	if len(val) == 1 {
		val = append(val, 0, 0, 0)
	}
	if len(val) == 2 {
		val = append(val, 0, 0)
	}
	...
	integerValue.Val = val
	integerValue.Type = valType
	return integerValue
}

func (i IntegerValue) Eval() (innodb.Value, error) {
	return NewIntegerValue(i.Val, i.Type), nil
}
func (i IntegerValue) Raw() interface{} {
	return util.ReadUB4Byte2Int(i.Val)
}

func (i IntegerValue) ToBytes() []byte {
	return i.Val
}

func (i IntegerValue) DataType() innodb.ValType {
	return i.Type
}

func (i IntegerValue) Compare(x innodb.Value) (innodb.CompareType, error) {
	panic("implement me")
}

func (i IntegerValue) UnaryPlus() (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) UnaryMinus() (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) Add(value innodb.Value) (innodb.Value, error) {
	if value.DataType() != common.COLUMN_TYPE_INT24 {
		return nil, errors.New("数据类型不匹配")
	}
	result := i.Raw().(int) + value.Raw().(int)
	leftValue := NewIntegerValue(util.ConvertInt4Bytes(int32(result)), i.Type)
	return leftValue, nil

}

func (i IntegerValue) Sub(value innodb.Value) (innodb.Value, error) {
	if value.DataType() != common.COLUMN_TYPE_INT24 {
		return nil, errors.New("数据类型不匹配")
	}
	result := i.Raw().(int) - value.Raw().(int)
...
func (i IntegerValue) Mul(value innodb.Value) (innodb.Value, error) {
	if value.DataType() != common.COLUMN_TYPE_INT24 {
		return nil, errors.New("数据类型不匹配")
	}
	result := i.Raw().(int) * value.Raw().(int)
...
func (i IntegerValue) Div(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) Pow(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) Mod(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) Equal(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) NotEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) GreaterThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) LessThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) GreaterOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) LessOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) And(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (i IntegerValue) Or(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}
...
func NewIntVal(in []byte) *SQLVal {
	...
	for i := 0; i < len(in); i++ {
		stringBuffer.WriteRune(rune(in[i]))
	}
	res, _ := strconv.Atoi(stringBuffer.String())

	integerValue.Val = util.ConvertInt4Bytes(int32(res))
	integerValue.Type = innodb.IntVal

	return (*SQLVal)(unsafe.Pointer(integerValue))
}
...
func (f FloatValue) Eval() (innodb.Value, error) {
	panic("FloatValue")
}
func (f FloatValue) Raw() interface{} {
	panic("implement me")
}

func (f FloatValue) DataType() innodb.ValType {
	panic("implement me")
}

func (f FloatValue) Compare(x innodb.Value) (innodb.CompareType, error) {
	panic("implement me")
}

func (f FloatValue) UnaryPlus() (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) UnaryMinus() (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Add(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Sub(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Mul(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Div(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Pow(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Mod(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Equal(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) NotEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) GreaterThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) LessThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) GreaterOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) LessOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) And(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (f FloatValue) Or(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

// NewFloatVal builds a new FloatVal.
func NewFloatVal(in []byte) *SQLVal {
	var floatVal = new(FloatValue)
	floatVal.Type = innodb.FloatVal
	floatVal.Val = in
	return (*SQLVal)(unsafe.Pointer(floatVal))
}
...
func (f HexNum) Eval() (innodb.Value, error) {
	panic("HexNum")
}
func (h HexNum) Raw() interface{} {
	panic("implement me")
}

func (h HexNum) DataType() innodb.ValType {
	panic("implement me")
}

func (h HexNum) Compare(x innodb.Value) (innodb.CompareType, error) {
	panic("implement me")
}

func (h HexNum) UnaryPlus() (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) UnaryMinus() (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Add(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Sub(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Mul(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Div(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Pow(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Mod(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Equal(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) NotEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) GreaterThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) LessThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) GreaterOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) LessOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) And(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (h HexNum) Or(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

// NewHexNum builds a new HexNum.
func NewHexNum(in []byte) *SQLVal {
	var hexNum = new(HexNum)
	hexNum.Type = innodb.HexNum
	hexNum.Val = in

	return (*SQLVal)(unsafe.Pointer(hexNum))
}

// NewHexVal builds a new HexVal.
func NewHexVal(in []byte) *SQLVal {
	return &SQLVal{Type: innodb.HexVal, Val: in}
}

// NewBitVal builds a new BitVal containing a bit literal.
func NewBitVal(in []byte) *SQLVal {
	return &SQLVal{Type: innodb.BitVal, Val: in}
}

// NewValArg builds a new ValArg.
func NewValArg(in []byte) *SQLVal {
	return &SQLVal{Type: innodb.ValArg, Val: in}
}
...
func (node *SQLVal) Format(buf *TrackedBuffer) {
	...
	case innodb.IntVal, innodb.FloatVal, innodb.HexNum:
...
func (node *SQLVal) Eval() (innodb.Value, error) {
	switch node.Type {
	case innodb.StrVal:
		strVal := NewStrVal(node.Val)
		return strVal.Eval()
	case innodb.IntVal:
		return NewIntegerValue(node.Val, node.Type), nil

	case innodb.FloatVal:
		floatVal := NewFloatVal(node.Val)
		return floatVal.Eval()
	case innodb.HexNum:
		hexNum := NewHexNum(node.Val)
		return hexNum.Eval()
	case innodb.HexVal:
		hexNum := NewHexVal(node.Val)
		return hexNum.Eval()
	case innodb.BitVal:
		hexNum := NewBitVal(node.Val)
		return hexNum.Eval()
	case innodb.ValArg:
		hexNum := NewValArg(node.Val)
		return hexNum.Eval()
	default:
		panic("unexpected")
	}
...
// NullVal represents a NULL valueImpl.
type NullVal struct {
}

func (node *NullVal) Raw() interface{} {
	panic("implement me")
}

func (node *NullVal) DataType() innodb.ValType {
	panic("implement me")
}

func (node *NullVal) Compare(x innodb.Value) (innodb.CompareType, error) {
	panic("implement me")
}

func (node *NullVal) UnaryPlus() (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) UnaryMinus() (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Add(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Sub(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Mul(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Div(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Pow(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Mod(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Equal(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) NotEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) GreaterThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) LessThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) GreaterOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) LessOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) And(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node *NullVal) Or(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}
...
func (node *NullVal) Eval() (innodb.Value, error) {
	panic("NullVal")
}
...
func (node BoolVal) Raw() interface{} {
	panic("implement me")
}

func (node BoolVal) DataType() innodb.ValType {
	panic("implement me")
}

func (node BoolVal) Compare(x innodb.Value) (innodb.CompareType, error) {
	panic("implement me")
}

func (node BoolVal) UnaryPlus() (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) UnaryMinus() (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Add(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Sub(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Mul(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Div(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Pow(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Mod(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Equal(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) NotEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) GreaterThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) LessThan(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) GreaterOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) LessOrEqual(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) And(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}

func (node BoolVal) Or(value innodb.Value) (innodb.Value, error) {
	panic("implement me")
}
func (node BoolVal) Eval() (innodb.Value, error) {
	panic("BoolVal")
}
...
func (node *ColName) Eval() (innodb.Value, error) {
	panic("ColName")
}
...
func (node ValTuple) Eval() (innodb.Value, error) {
	panic("implement me")
}
...
func (node *Subquery) Eval() (innodb.Value, error) {
	panic("Subquery")
}
...
func (node ListArg) Eval() (innodb.Value, error) {
	panic("ListArg")
}

// BinaryExpr represents a binary valueImpl expression.
...
func (node *BinaryExpr) Eval() (innodb.Value, error) {
	...
	case "+":
		{
			result, lastError := leftEval.Add(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
	...
	case "-":
		{
			result, lastError := leftEval.Sub(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
	...
	case "*":
		{
			result, lastError := leftEval.Mul(rightEval)
			if lastError != nil {
				return nil, lastError
			}
			return result, nil
...
// UnaryExpr represents a unary valueImpl expression.
...
func (node *UnaryExpr) Eval() (innodb.Value, error) {
	panic("UnaryExpr")
}
...
func (node *IntervalExpr) Eval() (innodb.Value, error) {
	panic("IntervalExpr")
}
...
func (node *CollateExpr) Eval() (innodb.Value, error) {
	panic("CollateExpr")
}
...
func (node *FuncExpr) Eval() (innodb.Value, error) {
	panic("FuncExpr")
}
...
func (node *GroupConcatExpr) Eval() (innodb.Value, error) {
	panic("GroupConcatExpr")
}
...
func (node *ValuesFuncExpr) Eval() (innodb.Value, error) {
	panic("ValuesFuncExpr")
}
...
func (node *SubstrExpr) Eval() (innodb.Value, error) {
	panic("SubstrExpr")
}
...
func (node *ConvertExpr) Eval() (innodb.Value, error) {
	panic("ConvertExpr")
}
...
func (node *ConvertUsingExpr) Eval() (innodb.Value, error) {
	panic("ConvertUsingExpr")
}
...
func (node *ConvertType) Eval() (innodb.Value, error) {
	panic("ConvertType")
}
...
func (node *MatchExpr) Eval() (innodb.Value, error) {
	panic("MatchExpr")
}
...
func (node *CaseExpr) Eval() (innodb.Value, error) {
	panic("CaseExpr")
}
...
func (node *Default) Eval() (innodb.Value, error) {
	panic("Default")
}
