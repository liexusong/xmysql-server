...
var MySqlFlag_name = map[int32]string{
	...
	32768: "NUM_FLAG",
	16384: "PART_KEY_FLAG",
	// Duplicate valueImpl: 32768: "GROUP_FLAG",
	65536:  "UNIQUE_FLAG",
	131072: "BINCMP_FLAG",
}
...
// position can be retrieved from vttablet when executing a plan. It
...
// Value represents a typed valueImpl.
type Value struct {
	Type  Type   `protobuf:"varint,1,opt,name=type,enum=plan.Type" json:"type,omitempty"`
	Value []byte `protobuf:"bytes,2,opt,name=valueImpl,proto3" json:"valueImpl,omitempty"`
}
...
// Field describes a single column returned by a plan
type Field struct {
	// name of the field as returned by mysql C API
	Name string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// vitess-defined type. Conversion function is in sqltypes package.
	Type Type `protobuf:"varint,2,opt,name=type,enum=plan.Type" json:"type,omitempty"`
...
type Row struct {
	// lengths contains the length of each valueImpl in values.
	// A length of -1 means that the field is NULL. While
	// reading values, you have to accummulate the length
	// to know the offset where the next valueImpl begins in values.
