...
func TestResolveList(t *testing.T) {
	...
	tcases := []struct {
		...
		err: "single valueImpl was supplied for TUPLE bind var",
	}, {
		in:  PlanValue{Key: "int"},
		err: "a single valueImpl was supplied where a list was expected",
	}}
...
func TestResolveValue(t *testing.T) {
	...
	tcases := []struct {
		...
		err: "TUPLE was supplied for single valueImpl bind var",
	}, {
		in:  PlanValue{ListKey: "intstr"},
		err: "a list was supplied where a single valueImpl was expected",
	}}
