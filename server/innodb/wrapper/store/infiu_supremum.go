...
func NewInfimumHeader() innodb.FieldDataHeader {
...
func ParseInfimumHeader(content []byte) innodb.FieldDataHeader {
	var clr = new(InfimumHeader)
...
func NewInfimumValue() innodb.FieldDataValue {
...
func (i *InfimumValue) GetPrimaryKey() innodb.FiledDataBytes {
	panic("implement me")
}
...
func NewInfimumRowByContent(content []byte) innodb.Row {
	var ir = &InfimumRow{
		Row:    nil,
...
func (ir *InfimumRow) Less(than innodb.Row) bool {
...
func (ir *InfimumRow) GetPrimaryKey() innodb.Value {
	panic("implement me")
}
...
func (ir *InfimumRow) ReadValueByIndex(index int) innodb.Value {
	panic("implement me")
}
...
func NewSupremumHeader() innodb.FieldDataHeader {
...
func ParseSupremumHeader(content []byte) innodb.FieldDataHeader {
	var clr = new(SupremumHeader)
...
func NewSupremumValue() innodb.FieldDataValue {
...
func (s *SupremumValue) GetPrimaryKey() innodb.FiledDataBytes {
	panic("implement me")
}
...
func (sr *SupremumRow) Less(than innodb.Row) bool {
...
****/
func NewSupremumRow() innodb.Row {
...
func NewSupremumRowByContent(content []byte) innodb.Row {
	var ir = &SupremumRow{
		Row:    nil,
...
func (sr *SupremumRow) GetPrimaryKey() innodb.Value {
	panic("implement me")
}
...
func (sr *SupremumRow) ReadValueByIndex(index int) innodb.Value {
	panic("implement me")
}
