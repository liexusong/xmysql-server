...
func (ph *PageHeader) WritePageHeaderNDirSlots(pageNdir int) {
	ph.PageNDirSlots = util.ConvertInt2Bytes(int32(pageNdir))
}
...
func NewIndexPage(pageNo uint32, spaceId uint32) *IndexPage {
	...
	fileHeader.WritePageFileType(common.FILE_PAGE_INDEX)
