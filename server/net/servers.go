...
//	infoSchemas schemas.InfoSchemas
//}
//
...
//		serverimpl = getty.NewTCPServer(serverOpts...)
//		// run serverimpl
//		serverimpl.RunEventLoop(func(session getty.Session) error {
//			var (
//				ok      bool
//				tcpConn *net.TCPConn
//			)
...
//		srv.serverList = append(srv.serverList, serverimpl)
//	}
//}
//
//func (srv *MySQLServer) uninitServer() {
//	for _, serverimpl := range srv.serverList {
//		serverimpl.Close()
//	}
//	if srv.taskPool != nil {
//		srv.taskPool.Close()
...
//
////启动加载管理本地数据库
//func (srv *MySQLServer) initInfosSchema() {
//	srv.infoSchemas = store.NewInfoSchemaManager(srv.conf)
//}
//
//func (srv *MySQLServer) initPurgeThread() {
//	go srv.purgeThread()
//}
//
//func (srv *MySQLServer) purgeThread() {
//	//count := 0
//	timeTicker := time.NewTicker(1 * time.Second)
//	for {
//		<-timeTicker.C
//		log.Info("purge协程在工作")
//		//fmt.Println("purge协程在工作")
//		//count++
//		//if count >= 5 {
//		//	timeTicker.Stop()
//		//}
